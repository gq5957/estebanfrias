  ...
  return (
    <div className="read-max space-y-10">
      <div className="space-y-4">
        ...
        <P>A small collection of high-signal notes. No content treadmill — just what’s worth publishing.</P>
      </div>

      <div className="space-y-12">
        {notes.map((n) => (
          <div key={n.slug} className="space-y-3">
            <Link to={`/notes/${n.slug}`} className="group inline-flex items-center gap-2 no-underline cursor-pointer">
              <span
